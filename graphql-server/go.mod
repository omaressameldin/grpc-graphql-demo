module github.com/omaressameldin/grpc-graphql-demo/graphql-server
...
require (
	...
	github.com/grokify/bitcoinmath v0.0.0-20171208015713-6ef5b53bef73 // indirect
	github.com/grokify/gmp v0.0.0-20150208031926-01ae2d55cff7 // indirect
