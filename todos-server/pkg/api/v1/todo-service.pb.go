...
type ToDo struct {
	...
	//	*ToDo_TitleValue
	Title isToDo_Title `protobuf_oneof:"title"`
	// Detail description of the todo task
	//
	// Types that are valid to be assigned to Description:
	//	*ToDo_DescriptionValue
	Description isToDo_Description `protobuf_oneof:"description"`
	// Date and time to remind the todo task
	//
	// Types that are valid to be assigned to Reminder:
	//	*ToDo_ReminderValue
	Reminder isToDo_Reminder `protobuf_oneof:"reminder"`
	// Types that are valid to be assigned to IsDone:
	//	*ToDo_IsDoneValue
	IsDone               isToDo_IsDone `protobuf_oneof:"isDone"`
...
type isToDo_Title interface {
	isToDo_Title()
}

type ToDo_TitleValue struct {
	TitleValue string `protobuf:"bytes,2,opt,name=title_value,json=titleValue,proto3,oneof"`
}

func (*ToDo_TitleValue) isToDo_Title() {}

func (m *ToDo) GetTitle() isToDo_Title {
	if m != nil {
		return m.Title
	}
	return nil
...
func (m *ToDo) GetTitleValue() string {
	if x, ok := m.GetTitle().(*ToDo_TitleValue); ok {
		return x.TitleValue
	}
	return ""
}

type isToDo_Description interface {
	isToDo_Description()
}

type ToDo_DescriptionValue struct {
	DescriptionValue string `protobuf:"bytes,3,opt,name=description_value,json=descriptionValue,proto3,oneof"`
}

func (*ToDo_DescriptionValue) isToDo_Description() {}

func (m *ToDo) GetDescription() isToDo_Description {
	if m != nil {
...
func (m *ToDo) GetDescriptionValue() string {
	if x, ok := m.GetDescription().(*ToDo_DescriptionValue); ok {
		return x.DescriptionValue
	}
	return ""
}

type isToDo_Reminder interface {
	isToDo_Reminder()
}

type ToDo_ReminderValue struct {
	ReminderValue *timestamp.Timestamp `protobuf:"bytes,4,opt,name=reminder_value,json=reminderValue,proto3,oneof"`
}

func (*ToDo_ReminderValue) isToDo_Reminder() {}

func (m *ToDo) GetReminder() isToDo_Reminder {
	if m != nil {
		return m.Reminder
	}
	return nil
...
func (m *ToDo) GetReminderValue() *timestamp.Timestamp {
	if x, ok := m.GetReminder().(*ToDo_ReminderValue); ok {
		return x.ReminderValue
	}
	return nil
}

type isToDo_IsDone interface {
	isToDo_IsDone()
}

type ToDo_IsDoneValue struct {
	IsDoneValue bool `protobuf:"varint,5,opt,name=isDone_value,json=isDoneValue,proto3,oneof"`
}

func (*ToDo_IsDoneValue) isToDo_IsDone() {}

func (m *ToDo) GetIsDone() isToDo_IsDone {
	if m != nil {
		return m.IsDone
	}
	return nil
...
func (m *ToDo) GetIsDoneValue() bool {
	if x, ok := m.GetIsDone().(*ToDo_IsDoneValue); ok {
		return x.IsDoneValue
	}
	return false
}
...
func (*ToDo) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ToDo_OneofMarshaler, _ToDo_OneofUnmarshaler, _ToDo_OneofSizer, []interface{}{
		(*ToDo_TitleValue)(nil),
		(*ToDo_DescriptionValue)(nil),
		(*ToDo_ReminderValue)(nil),
		(*ToDo_IsDoneValue)(nil),
	}
}
...
func _ToDo_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *ToDo_TitleValue:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.TitleValue)
	case nil:
	default:
		return fmt.Errorf("ToDo.Title has unexpected type %T", x)
	}
	// description
	switch x := m.Description.(type) {
	case *ToDo_DescriptionValue:
		b.EncodeVarint(3<<3 | proto.WireBytes)
		b.EncodeStringBytes(x.DescriptionValue)
	case nil:
	default:
		return fmt.Errorf("ToDo.Description has unexpected type %T", x)
	}
	// reminder
	switch x := m.Reminder.(type) {
	case *ToDo_ReminderValue:
		b.EncodeVarint(4<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ReminderValue); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("ToDo.Reminder has unexpected type %T", x)
	}
	// isDone
	switch x := m.IsDone.(type) {
	case *ToDo_IsDoneValue:
		t := uint64(0)
		if x.IsDoneValue {
			t = 1
		}
	...
	case nil:
	default:
		return fmt.Errorf("ToDo.IsDone has unexpected type %T", x)
	}
	return nil
}
...
func _ToDo_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ToDo)
	switch tag {
	case 2: // title.title_value
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Title = &ToDo_TitleValue{x}
		return true, err
	case 3: // description.description_value
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
		m.Description = &ToDo_DescriptionValue{x}
		return true, err
	case 4: // reminder.reminder_value
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(timestamp.Timestamp)
		err := b.DecodeMessage(msg)
		m.Reminder = &ToDo_ReminderValue{msg}
		return true, err
	case 5: // isDone.isDone_value
		if wire != proto.WireVarint {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeVarint()
		m.IsDone = &ToDo_IsDoneValue{x != 0}
		return true, err
	default:
		return false, nil
	}
...
func _ToDo_OneofSizer(msg proto.Message) (n int) {
	...
	case *ToDo_TitleValue:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.TitleValue)))
		n += len(x.TitleValue)
	case nil:
	default:
	...
	case *ToDo_DescriptionValue:
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(len(x.DescriptionValue)))
		n += len(x.DescriptionValue)
	case nil:
	default:
		panic(fmt.Sprintf("proto: unexpected type %T in oneof", x))
	}
...
type ReadAllRequest struct {
	// API versioning: it is my best practice to specify version explicitly
	Api                  string   `protobuf:"bytes,1,opt,name=api,proto3" json:"api,omitempty"`
	JustRemaining        bool     `protobuf:"varint,2,opt,name=justRemaining,proto3" json:"justRemaining,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ReadAllRequest) GetJustRemaining() bool {
	if m != nil {
		return m.JustRemaining
	}
	return false
}
...
var fileDescriptor_80b701c7b1c502fe = []byte{
	...
	,
}
